...
export async function POST(req){
  try{
    ...
    if(!STORES.some(x=>x.id===storeId&&!['costco-online','uniqlo-online','akachan-online','nishimatsuya-online'].includes(x.type)))return NextResponse.json({error:'登録対象店舗が正しくありません'},{status:400});
