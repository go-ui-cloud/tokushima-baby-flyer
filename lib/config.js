export const STORES = [
  ...
  ,{
    id:'uniqlo-online', chain:'UNIQLO', area:'オンラインチラシ', exactStoreName:'UNIQLO オンラインチラシ',
    address:'オンライン', storeKeywords:['UNIQLO','ユニクロ','ベビー'], type:'uniqlo-online',
    sources:[
      {provider:'official',label:'UNIQLO公式',url:'https://www.uniqlo.com/jp/ja/baby/newborn2'}
    ]
  }
  ,{
    id:'akachan-online', chain:'アカチャンホンポ', area:'オンライン', exactStoreName:'アカチャンホンポ オンライン',
    address:'オンライン', storeKeywords:['アカチャンホンポ','オンラインショップ','ベビー'], type:'akachan-online',
    sources:[
      {provider:'official',label:'紙おむつ（テープ）',url:'https://shop.akachan.jp/shop/c/cb327/'},
      {provider:'official',label:'紙おむつ（パンツ）',url:'https://shop.akachan.jp/shop/c/cb328/'},
      {provider:'official',label:'新生児ミルク',url:'https://shop.akachan.jp/shop/c/cb162/'},
      {provider:'official',label:'離乳食1',url:'https://shop.akachan.jp/shop/c/cb167_ssld/'},
      {provider:'official',label:'離乳食2',url:'https://shop.akachan.jp/shop/c/cb168_ssld/'},
      {provider:'official',label:'離乳食3',url:'https://shop.akachan.jp/shop/c/cb169_ssld/'},
      {provider:'official',label:'離乳食4',url:'https://shop.akachan.jp/shop/c/cb170_ssld/'},
      {provider:'official',label:'ベビーおやつ1',url:'https://shop.akachan.jp/shop/c/cb172_ssld/'},
      {provider:'official',label:'ベビーおやつ2',url:'https://shop.akachan.jp/shop/c/cb173_ssld/'},
      {provider:'official',label:'ベビーおやつ3',url:'https://shop.akachan.jp/shop/c/cb174_ssld/'}
    ]
  }
  ,{
    id:'nishimatsuya-online', chain:'西松屋', area:'オンライン', exactStoreName:'西松屋 オンライン',
    address:'オンライン', storeKeywords:['西松屋','オンラインストア','ベビー'], type:'nishimatsuya-online',
    sources:[
      {provider:'official',label:'ミルク等',url:'https://www.24028-net.jp/category/MEAL/?s8%5B%5D=1'},
      {provider:'official',label:'オムツ等',url:'https://www.24028-net.jp/category/EXCRETION/?s8%5B%5D=1'}
    ]
  }
...
export const BABY_TERMS = {
  // V2.18: OCR上に「おむつ」「ミルク」「離乳食」が無くても、代表的なブランド・シリーズ名から分類する。
  'おむつ・おしりふき':[
    'おむつ','オムツ','紙おむつ','紙オムツ','diaper','diapers',
    'パンパース','Pampers','さらさらケア','肌へのいちばん','はじめての肌へのいちばん',
    'メリーズ','Merries','ファーストプレミアム','ずっと肌さら','ぐっすりパンツ',
    'ムーニー','moony','ナチュラルムーニー','オヤスミマン','トレパンマン',
    'グーン','GOO.N','GOON','ぐんぐん吸収パンツ','まっさらさら通気',
    'マミーポコ','MamyPoko','Genki','ゲンキ','ネピアWhito','Whito',
    'おやすみパンツ','おしりふき','お尻ふき','おしり拭き','手口ふき','手口拭き'
  ],
  '粉ミルク・液体ミルク':[
    '粉ミルク','液体ミルク','乳児用ミルク','育児用ミルク','フォローアップミルク',
    'ほほえみ','らくらくキューブ','らくらくミルク','ステップ',
    'はぐくみ','E赤ちゃん','e赤ちゃん','チルミル','エコらくパック',
    'ぴゅあ','たっち','すこやかM1','すこやか','つよいこ','アイクレオ','バランスミルク','グローアップミルク',
    'はいはい','ぐんぐん','レーベンスミルク','BeanStalk','ビーンスターク'
  ],
  '離乳食・ベビーフード':[
    '離乳食','ベビーフード','baby food',
    'キユーピーベビーフード','キユーピー ベビーフード','キューピーベビーフード','にこにこボックス','すまいるカップ','ハッピーレシピ','瓶詰',
    '和光堂','WAKODO','栄養マルシェ','グーグーキッチン','BIGサイズの栄養マルシェ','はじめての離乳食','手作り応援','赤ちゃんのおやつ','赤ちゃんのやさしいおやつ',
    'ピジョン ベビーフード','食育レシピ','管理栄養士の食育ステップレシピ','レンジで蒸しパン','赤ちゃんのソフトふりかけ'
  ],
  ...
  ,'ウェア':['肌着','ボディスーツ','カバーオール','サロペット','Tシャツ','スウェット','レギンス','パンツ','アウター','ジャケット','パーカ','ソックス','UNIQLO','ユニクロ']
};
